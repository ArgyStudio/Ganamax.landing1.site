...
(function(){
  const data = [
    { name: "Alejandro Pérez",   time: "10:12 am", text: "Entré por un video de Facebook, cuadruplicaron mi carga y con eso pude sacar el cuádruple de premio." },
    { name: "María Gómez",       time: "9:45 pm",  text: "Vi el anuncio en Facebook, pensé que era mentira pero me dieron el 300% extra y pude jugar más." },
    { name: "Lucas Rodríguez",   time: "2:30 pm",  text: "Los cajeros de GANAMAX responden muy rápido y son bastante atentos." },
    { name: "Valentina Sánchez", time: "8:20 am",  text: "Cuadrupliqué mi carga y con eso aumenté considerablemente mis chances de ganar." },
    ...
    { name: "Diego Fernández",   time: "11:05 am", text: "Con el bono del 300% pude probar más juegos y terminé ganando." },
    { name: "Florencia Torres",  time: "4:40 pm",  text: "Vi el anuncio, no lo creía, probé y pagaron al instante." },
    { name: "Ignacio Vázquez",   time: "9:15 pm",  text: "Cuadrupliqué la carga por una promo y me fue genial: retiré rápido." },
    ...
    { name: "Julieta Navarro",   time: "1:20 pm",  text: "Pensé que era humo, pero probé y me acreditaron el 300% extra." },
    ...
    { name: "Ramiro Tévez",      time: "2:05 pm",  text: "Cuadrupliqué mi carga con la promo y subieron mucho mis chances." },
    { name: "Bianca Zapata",     time: "9:40 am",  text: "Los cajeros de GANAMAX son rápidos y el soporte resolvió una duda al toque." },
    { name: "Ezequiel Duarte",   time: "4:55 pm",  text: "Entré por un anuncio y me dieron el 300% extra: pude jugar más y ganar." },
    ...
    { name: "Micaela Arce",      time: "6:45 pm",  text: "Cuadrupliqué mi carga y conseguí jugadas que terminaron bien." },
    ...
    { name: "Lucas Tello",       time: "12:00 pm", text: "El bono del 300% realmente te da más oportunidades de juego." },
    { name: "Vanesa Roldán",     time: "10:05 am", text: "Muy buena la atención de esta gente, me asesoraron en todo." },
    { name: "Federico Urrutia",  time: "7:27 pm",  text: "Cuadrupliqué la carga en una promo y salió redondo: pude retirar rápido." },
    { name: "Victoria Pereyra",  time: "6:22 pm",  text: "Los cajeros de GANAMAX responden muy rápido." },
    { name: "Pablo Salinas",     time: "9:18 am",  text: "Vi el anuncio y probé: me dieron el 300% extra y gané algunas jugadas." },
    { name: "Mónica Kogan",      time: "8:00 pm",  text: "Muy buena plataforma, estable y sin contratiempos." },
    { name: "Hugo Luna",         time: "2:45 pm",  text: "Entré por un video, cuadruplicaron mi carga y pude jugar al máximo." },
    ...
    { name: "Diego Rojas",       time: "2:15 pm",  text: "Cuadrupliqué mi carga con la promo y aumentaron mis chances de premio." },
    ...
    { name: "Patricia Morel",    time: "5:30 pm",  text: "Con el 300% extra pude jugar más y aprovechar una buena racha." },
    ...
    { name: "Bruno Quiroga",     time: "10:25 am", text: "Cuadrupliqué la carga y terminé sacando un premio grande." },
    { name: "Daniela Tedesco",   time: "6:50 pm",  text: "Muy buena plataforma, simple y rápida para jugar." },
    { name: "Rodrigo Ledesma",   time: "9:35 am",  text: "Los cajeros de GANAMAX me dieron respuesta enseguida." },
    { name: "Inés Paredes",      time: "7:10 pm",  text: "Vi el anuncio en Facebook y dije 'probemos' — resultó mejor de lo que esperaba." },
    { name: "Sebastián Ameghino",time: "1:05 pm",  text: "Cuadrupliqué mi carga por una promo y pude jugar muchas manos." },
    { name: "Carla Varela",      time: "5:55 pm",  text: "La atención fue muy buena, me guiaron paso a paso." },
    { name: "Mauro Zárate",      time: "3:40 pm",  text: "Entré por un video y me acreditaron el 300%: rudimentario pero efectivo." },
